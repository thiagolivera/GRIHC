<?php
$_SESSION['p'] = "Membros da Família - Questão 4";
$pagina = $_SESSION['p'];
...
<body onload='tutorial()'>
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-3 col-lg-2" list-group-item" style="border: 0;">
									...
									<div class="progress">
							  			<div class="progress-bar progress-bar-success" role="progressbar" aria-valuenow="70"
							  				aria-valuemin="0" aria-valuemax="100" style="width:47.2%">
							    			<span class=""></span>
							  			</div>
									</div>
                                	<div style="text-align: center">
	                                	<div class="row">
											<i class="col-xs-12 titulo">Complete a frase:</i>
	                                	</div>
	                                	<div class="row titulo">
		                                	<p>My <input onkeypress="return processarEnter(event);"  class="" type="text" id="resposta" name="resposta" class="form-control" placeholder="..." style="    width: 150px;"> is walking whith our grandfather.</p>
		                                	<p>Meu irmão está caminhando com nosso avô.</p>
	                                	</div>
	                                	</div>
    ...
    function mostrarValor() {
		...
		function resposta(){
			var resposta = document.getElementById('resposta').value;
			alert("fadfasd");
	    	if(resposta == "" || resposta != "boy" || resposta != "Boy"){
		    	alert("respota errada (" + resposta + ")");
	    	}else{
