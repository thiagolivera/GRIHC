<?php
$_SESSION['p'] = "Membros da Família - Questão 2";
$pagina = $_SESSION['p'];
...
<body onload='tutorial()'>
								...
								<div class="col-xs-12 col-sm-12 col-md-9 col-lg-10" style="margin-top: 4px;">
							      	<div class="progress">
							  			<div class="progress-bar progress-bar-success" role="progressbar" aria-valuenow="70"
							  				aria-valuemin="0" aria-valuemax="100" style="width:28.6%">
							    			<span class=""></span>
							  			</div>
									</div>
								</div>
                                	<div style="text-align: center">
	                                	<div class="row">
											<i class="col-xs-12 titulo">Qual desses é uma "Mãe"?</i>
	                                	</div>
	                                	<div class="row">
		                                	<i class="col-xs-12 col-sm-6 col-md-3 titulo"><img id="imagem" src="img/mother.svg" alt="Bom trabalho!" height="auto" width="100%">Mother</i>
		                                	...
		                                	<i class="col-xs-12 col-sm-6 col-md-3 titulo"><img id="imagem" src="img/grandfather.svg" alt="Bom trabalho!" height="auto" width="100%">Grandfather</i>
		                                	<i class="col-xs-12 col-sm-6 col-md-3 titulo"><img id="imagem" src="img/man.svg" alt="Bom trabalho!" height="auto" width="100%">Man</i>
	                                	</div>
	                                	</div>
    ...
    function mostrarValor() {
    	...
    	if(resposta == "Mother" || resposta == "mother"){
    		$("#certo").modal();
    	}else if(resposta == ""){
