<?php
$_SESSION['p'] = "Membros da Família - Questão 5";
$pagina = $_SESSION['p'];
...
<body onload='tutorial()'>
								...
								<div class="col-xs-12 col-sm-12 col-md-9 col-lg-10" style="margin-top: 4px;">
							      	<div class="progress">
							  			<div class="progress-bar progress-bar-success" role="progressbar" aria-valuenow="70"
							  				aria-valuemin="0" aria-valuemax="100" style="width:71.5%">
							    			<span class=""></span>
							  			</div>
									</div>
								</div>
                                	<div style="text-align: center">
	                                	<div class="row">
											<i class="col-xs-12 titulo">Qual desses é um "Avô"?</i>
	                                	</div>
	                                	<div class="row">
    ...
    function mostrarValor() {
    	...
    	if(resposta == "Grandfather" || resposta == "grandfather"){
    		$("#certo").modal();
    	}else if(resposta == ""){
