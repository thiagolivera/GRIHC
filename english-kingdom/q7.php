<?php
$_SESSION['p'] = "Membros da Família - Questão 7";
$pagina = $_SESSION['p'];
...
<body onload='tutorial()'>
	...
	<div class="modal fade" data-backdrop="static" id="certo" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" style="background-color: rgba(0, 0, 0, 0.56);">
	  <div class="modal-dialog" role="document" style="width: 400px;margin: 120px auto;">
	    <i><img id="imagem" src="img/medal.svg" alt="Bom trabalho!" height="auto" width="100%"></i>
								...
								<div class="col-xs-12 col-sm-12 col-md-9 col-lg-10" style="margin-top: 4px;">
                                	...
                                	<div style="text-align: center">
	                                	...
	                                	<div class="row titulo">
		                                	<p>My <input onkeypress="return processarEnter(event);"  class="" type="text" id="resposta" name="resposta" class="form-control" placeholder="..." style="    width: 150px;"> is cooking with our grandmother.</p>
		                                	<p>Minha irmã está cozinhando com nossa avó.</p>
	                                	</div>
	                                	</div>
