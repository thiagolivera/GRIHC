                        ...
                        <div class="panel panel-default">
                            <div class="panel-body">
								...
								<div class="col-xs-6 col-sm-4 col-md-3 col-lg-2 item-iventario list-group-item" style="border: 0;">
                                	...
                                	<div style="text-align: center"><label><?php echo $item7->nome;?></div></label>
									<div class="btn btn-warning col-xs-12" style="margin-bottom: 5px" >Equipar</div></a>
									<button type="button" class="btn btn-primary col-xs-12"  style="margin-bottom: 5px" data-toggle="modal" data-target="#exampleModal" 
										data-nomeitem="<?php echo $item7->nome;?>"
										data-ataque="<?php echo $item7->ataque;?>"
										data-defesa="<?php echo $item7->defesa;?>"
										data-especial="<?php echo $item7->especial;?>"
										data-imagem="<?php echo $item7->imagem;?>"
										data-estoque="<?php echo $item7->total;?>">
										Ver detalhes
									</button>
								</div>
								<div class="col-xs-6 col-sm-4 col-md-3 col-lg-2 item-iventario list-group-item" style="border: 0;">
    ...
    <script type="text/javascript">
    	$('#exampleModal').on('show.bs.modal', function (event) {
			...
			// If necessary, you could initiate an AJAX request here (and then do the updating in a callback).
    	  	...
    	  	modal.find('#defesa').text(		' '+recipientDefesa)
    	  	modal.find('#ataque').text(		' '+recipientAtaque)
