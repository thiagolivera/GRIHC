...
<html lang="pt-br">
  ...
  <body>
    ...
    <div id="cwrap" style="padding-top: 20px; padding-bottom: 50px;">
            ...
            <div class="hline"></div>
            <p style="font-size: 16px; text-align: justify;">O objetivo geral desta ação é desenvolver habilidades de projeto de sistemas, raciocínio lógico e algorítmico nos estudantes do ensino médio da cidade de Russas, tendo como fim o desenvolvimento de sistemas acessíveis voltados para resolução de problemas de pessoas com deficiência.
        </div>
